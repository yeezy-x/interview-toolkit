...
const SummaryCard = ({
  ...
  return (
    <div className='bg-white border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group' onSelect={onSelect}>
        ...
        <div className='px-3 pb-3'>
            <div className='flex items-center gap-3 mt-4'>
                ...
                <div className='text-[10px] font-medium text-black px-3 py-1 border-[0.5[x] border-gray-900 rounded-full '>
                    {questions} Q&A
                </div>
